<template>
  <header>
    <div class="header-left">
      <RouterLink to="/">
        <div v-if="routeUrl.name === 'home'" class="logo-circle"></div>
        <svg v-else
          width="24"
          height="24"
          viewBox="0 0 16 16"
    ...
    <div class="header-right" v-if="routeUrl.name !== 'contacto'">
      <ButtonContact />
    </div>
  </header>
...
import ButtonContact from "@/components/buttons/ButtonContact.vue";
