<template>
  <div class="contenido">
    <div>
      <h1>Hola!</h1>
      <p>Puedes contactar conmigo a través de estos canales:</p>
      <div>
        <a class="links" href="mailto: marsenengilabert@gmail.com">
          <svg
            width="23"
            height="23"
            viewBox="0 0 23 23"
          ...
          marsenengilabert@gmail.com
        </a>
        <a
          class="links"
          href="https://www.linkedin.com/in/marsenen/"
          target="_blank"
        >
          <svg
            width="24"
          ...
          www.linkedin.com/in/marsenen
        </a>
        <a class="links" href="https://github.com/Marsen5" target="_blank">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    <div>
      <img src="../../public/img/foto.jpg" alt="Foto_Mar" />
    </div>
  </div>
</template>
